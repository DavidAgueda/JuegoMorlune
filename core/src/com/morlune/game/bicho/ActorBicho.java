...
public abstract class ActorBicho {
	...
	public ActorBicho(Sprite miBicho, int damage, int points, int velocity) {
		...
		velocidad = velocity;
		this.damage = damage;
		// hacer que solo aparezcan en los bordes
		...
		this.miBicho = new Sprite(miBicho);
		this.miBicho.setPosition(posicionX, posicionY);
		// instancia de rectangulo de colision
		rectangleBicho = new Rectangle(posicionX, posicionY,this.miBicho.getWidth(), this.miBicho.getHeight());
		this.miBicho.rotate((float)orientar()+180);
	}
